...
/**
 * Classe Modelo
 * Responsável por automatizar as buscas, inserção e edição de dados nas
 * classes filhas
 * @author Jose Tadeu
 */
...
class Modelo
{
    ...
    public function salvar()
    {
        ...
        if (empty($this->id)) {
            ...
            if ($this->erro) {
                $this->mensagem->erro('Erro ao tentar cadastrar os dados');
            }
        }
        ...
        if (!empty($this->id)) {
            ...
            if ($this->erro) {
                $this->mensagem->erro('Erro ao tentar atualizar os dados');
            }
        }
